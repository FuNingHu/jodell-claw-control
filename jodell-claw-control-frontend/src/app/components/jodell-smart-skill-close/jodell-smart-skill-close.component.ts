...
@Component({
    templateUrl: './jodell-smart-skill-close.component.html',
    styleUrls: ['./jodell-smart-skill-close.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: false,
})
export class JodellSmartSkillCloseComponent implements SmartSkillPresenter, OnChanges {
    @Input()
    // instance: SmartSkillInstance;
    instance: JodellSmartSkillCloseInstance;
